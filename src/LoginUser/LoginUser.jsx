  ...
  <div className='d-flex justify-content-center align-items-center'>
      ...
      <form className={desgin.form_container} onSubmit={formikobj.handleSubmit}>
        ...
        <div className={desgin.input_container}>
          ...
          <input onChange={formikobj.handleChange} onBlur={formikobj.handleBlur} value={formikobj.values.password} placeholder="Password" title="Inpit title" name="password" type="password" className={desgin.input_field} id="password_field"/>
        ...
        <button title="Sign In" type="submit" className={desgin.sign_in_btn}>
          <span className={font.font2 + ' fw-bold fs-5'}>
